...
export default defineAstroI18nConfig({
	...
	routeTranslations: {
		en: {
			...
			"solutions": 'solutions',
			"web": "solutions/web",
			"grafisch-ontwerp": "solutions/graphic-design",
			"online-marketing": "solutions/online-marketing",
			"3d-visualisatie": "solutions/3d-visualisation",
			"audiovisueel": "solutions/audiovisual",
			"artificiele-intelligentie": "solutions/artificial-intelligence",
			"contact": "contact",
			"blog": "blog",
		}
	},
